...
export default function Home() {
  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[#0b0b0a] text-[#f4f0e8]">
      ...
      <section className="bg-[#151512] py-5"><div className="mx-auto grid max-w-7xl gap-5 px-5 sm:px-8 md:grid-cols-[1.1fr_.9fr]"><div className="relative min-h-[460px] overflow-hidden border border-white/10 bg-[#0b0b0a]"><img src="/assets/lucas-poster.png" alt="Arte de serviços Lucas do Corte" className="absolute inset-0 h-full w-full object-cover object-center opacity-60 transition duration-700 hover:scale-105" /><div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/80 to-transparent p-7"><p className="text-xs font-bold uppercase tracking-[0.25em] text-[#e2a632]">01 / O ambiente</p><p className="mt-2 font-display text-4xl tracking-wide">A CADEIRA É SUA.</p></div></div><div className="relative min-h-[460px] overflow-hidden border border-white/10 bg-[#0b0b0a]"><img src="https://images.unsplash.com/photo-1621605815971-fbc98d665033?auto=format&fit=crop&w=1000&q=85" alt="Ferramentas de barbeiro" className="absolute inset-0 h-full w-full object-cover opacity-70 transition duration-700 hover:scale-105" /><div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/80 to-transparent p-7"><p className="text-xs font-bold uppercase tracking-[0.25em] text-[#e2a632]">02 / O detalhe</p><p className="mt-2 font-display text-4xl tracking-wide">PRECISÃO NA LÂMINA.</p></div></div></div></section>
